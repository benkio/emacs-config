...
3. Set:
   ...
   4. Alwayst load newest byte code first
...
(setq load-prefer-newer t)                                      ;3-4
(setq gc-cons-threshold 50000000)                               ;3-5
(setq tab-always-indent 'complete)				;3-6
(when (eq system-type 'windows-nt)                              ;3-7
