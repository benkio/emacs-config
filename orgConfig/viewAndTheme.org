...
(defun fontify-frame (frame)
  ...
  (if window-system
	...
	((pred (lambda (x) (> x 3000))) (set-frame-font "Ubuntu Mono 17"))
	((pred (lambda (x) (> x 2000))) (set-frame-font "Ubuntu Mono 14"))
	((pred (lambda (x) (< x 2000))) (set-frame-font "Ubuntu Mono 10")))
    ))
