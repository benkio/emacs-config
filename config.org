  ...
  #+begin_src emacs-lisp :tangle yes
    (defun get-drobox-link (file)
      ...
      (setq
          ...
          command (concat "maestral sharelink list \"" filePathInDropbox "\"")
          dropboxLinks (shell-command-to-string command)
          dropboxLink (car (s-split "\n" dropboxLinks))
       )
      (kill-new dropboxLink)
      )
  #+end_src
