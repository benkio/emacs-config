...
#+begin_src emacs-lisp
  ...
  eg. \\(.*class  inputType .*\\|.*trait  inputType .*\\|.*object  inputType .*\\|.*type  inputType .*\\) to go to a scala definition
...
#+BEGIN_SRC emacs-lisp
  (setq scalaDefinitionRegex (lambda (type) (concat "\\(.*class " inputType ".*\\|.*trait " inputType ".*\\|.*object " inputType ".*\\|.*type " inputType ".*\\)")))
...
#+BEGIN_SRC emacs-lisp
  (setq typescriptDefinitionRegex (lambda (type) (concat "\\(.*class " inputType ".*\\|.*interface " inputType ".*\\|.*type " inputType ".*\\)")))
...
#+BEGIN_SRC emacs-lisp
  (setq csharpDefinitionRegex (lambda (type) (concat "\\(.*class " inputType ".*\\|.*interface " inputType ".*\\|.*enum " inputType ".*\\)")))
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c c s d") 'scala-goto-definition)
#+end_src
*** Haskell
#+begin_src emacs-lisp
