...
#+begin_src emacs-lisp
  (use-package format-all
    ...
    :config
    (setq-default format-all-formatters '(("Haskell" fourmolu)))
    )
#+end_src
      ...
      (defun scala-open-doc (queryType lib)
        ...
        (interactive (list
                      ...
                      (completing-read "Library: "
                                       '("Cats" "Cats-Effect" "Circe" "Doobie" "Http4s 0.23" "Monocle core 2.13" "Munit core 2.13" "Natchez Core" "Scalacheck" "Skunk core 2.13" "Spark" "Standard Library" "fs2 core 3") nil t)
                      ))
        (require 'browse-url)
