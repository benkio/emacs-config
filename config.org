...
* Packages
** Aria 2
  Major mode to control Aria 2 from emacs. A command line download utility to download stuff (torrent, FTP ...)
      ...
      (defun scala-open-doc (queryType lib)
        ...
        (interactive (list
                      ...
                      (completing-read "Library: "
                                       '("Cats" "Cats-Effect" "Circe" "Doobie" "Http4s 0.23" "Monocle core 2.13" "Munit core 2.13" "Natchez Core" "Scalacheck" "Skunk core 2.13" "Spark" "Standard Library" "fs2 core 3" "Weaver") nil t)
                      ))
        (require 'browse-url)
        (setq libUrlPrefix (cond
                            ...
                            ((string= lib "Natchez Core")      "https://www.javadoc.io/static/org.tpolecat/natchez-core_3/0.2.0/natchez.html?search=")
                            ...
                            ((string= lib "Weaver")            "https://javadoc.io/static/com.disneystreaming/weaver-core_sjs1_3/0.7.6/api/index.html?search=")
