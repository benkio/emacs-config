  ...
  (defun dev-open-doc (queryType lib)
    ...
    (interactive (list
                  ...
                  (completing-read "Library: "
                                   '("angular" "backbone" "cpp" "coffeescript" "crystal" "elixir" "javascript" "julia" "jquery" "knockout" "kubernetes" "less" "lodash" "love" "marionette" "markdown" "matplotlib" "modernizr" "moment" "openjdk" "nginx" "numpy" "pandas" "postgresql" "python" "rails" "ruby" "rust" "sass" "tensorflow" "typescript" "underscore.js") nil nil)
                  ))
    (require 'browse-url)
