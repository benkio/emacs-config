    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (defun set-font-height-on-frame-width (&optional frame)
        ...
        (let* ((frameWidth (frame-outer-width frame))
               ...
               (height (if (< heightComputed 0) 148 heightComputed))
               )
      ...
      (defun scala-open-doc (queryType lib)
        ...
        (interactive (list
                      ...
                      (completing-read "Library: "
                                       '("Standard Library" "Cats" "Cats-Effect" "Http4s 0.21" "fs2 core 3" "Circe") nil t)
                      ))
        (require 'browse-url)
        (setq libUrlPrefix (cond
                            ...
                            ((string= lib "Circe")       "https://circe.github.ioo/circe/api/index.html?search=")
