...
*** Higher Order
    ...
    #+begin_src emacs-lisp
      ...
      (defun extract-code-line-or-region-template (value function postDefinitionSyntaxValue postDefinitionSyntaxFunc parameterPrefix parameterSeparator parameterPostfix EndSyntaxValue EndSyntaxFunc name parameters from to)
        "Template for extracting code to value or function:
         ...
         - ParameterSeparator: Between each parameter
         - ParameterPostfix: at the end of parameter list
        ...
        (setq resultDefinition (if (string-blank-p parameters)
                                 ...
                                 (concat function name parameterPrefix (mapconcat 'identity parameters parameterSeparator) parameterPostfix postDefinitionSyntaxFunc code EndSyntaxFunc)))
...
*** Scala
    ...
    #+BEGIN_SRC emacs-lisp
      ...
      (defun scala-extract-code-line-or-region (name &optional parameters from to)
        ...
        (funcall 'extract-code-line-or-region-template "val " "def " " = {" " = " "(" "," ")" nil "}" name parameters from to)
        )
...
*** Haskell
    ...
    #+begin_src emacs-lisp
      ...
      (defun hs-extract-code-line-or-region (name &optional parameters from to)
        ...
        (funcall 'extract-code-line-or-region-template "" "" " = " " = " "" "" " " " " nil name parameters from to))
