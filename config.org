...
*** Theme
    ...
    #+BEGIN_SRC emacs-lisp
      (defun benkio-dark-theme ()
        ...
        (set-face-attribute 'idle-highlight nil :background "SlateBlue4")
        )
      ...
      (defun benkio-light-theme ()
        ...
        (set-face-attribute 'region nil :background "light slate blue")
        (set-face-attribute 'idle-highlight nil :background "snow4")
        )
