...
*** Set
    ...
    14. Cursor as a line
    15. Ido Fuzzy matching https://www.emacswiki.org/emacs/InteractivelyDoThings#h5o-23
    16. Ido Vertical Results
...
and into the files like find. Using fd
...
#+begin_src emacs-lisp
  ...
  (global-set-key (kbd "C-c r f") 'ido-recentf-open)
...
use IDO for completition of some keybindings
